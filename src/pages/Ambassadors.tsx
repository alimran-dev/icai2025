...
import ambassadorsData from "../../data/ambassadors2026.json"; // ICAI 2026 ambassadors

// ==========================================================================
// ICAI 2026 Ambassadors
//
// Displays the official ambassador list with search and pagination.
// The "Get Your Certificate" button will be added after the congress.
// ==========================================================================
...
export default function Ambassadors() {
  ...
  const filteredAmbassadors = useMemo(() => {
    ...
    return (ambassadorsData as Ambassador[]).filter((amb: Ambassador) => {
      const nameMatch = amb.name.toLowerCase().includes(term);
      const uniMatch = amb.university.toLowerCase().includes(term);
      const idMatch = amb.id.toLowerCase().includes(term);
      ...
      <section className="bg-primary-700 py-16 text-white">
        <div className="container">
          ...
          >
            ...
            {/* Certificate button will be added after the congress */}
            {/* 
            <motion.div ...>
