...
import speakersData from "../../data/speakers2026.json"; // ICAI 2026 speakers

// ============================================================
// ICAI 2026 Speakers – live data from speakers2026.json
// Placeholder images are used where real photos are missing.
// Replace the placeholder URLs with actual speaker photos.
// ============================================================
  ...
  return (
    <div className="pt-20 bg-gray-50">
        ...
        <div className="container relative z-10 px-4 mx-auto">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-primary-50 leading-relaxed">
              Meet the internationally renowned experts who will share their
              insights at ICAI 2026.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        >
          {(speakersData as Speaker[]).map((speaker, index) => (
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col pt-16 mt-6">
                ...
                <div className="px-6 pb-6 flex-grow flex flex-col text-center">
                  <div className="mb-4">
                    ...
                    <p className="text-primary-600 font-medium whitespace-pre-line mt-1">
                      {speaker.title}
                    </p>
                  </div>
